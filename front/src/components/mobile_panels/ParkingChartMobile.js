...
import "../../mobile_css/ParkingChartMobile.css";
...
function CustomTooltip({ active, payload, label }) {
    ...
    return (
        <div className="pc-tooltip" role="dialog" aria-label="차트 툴팁">
            ...
            <div className="pc-tip-row" style={{fontSize:30}}><span className="pc-badge live" style={{fontSize:30}}>주차</span><b style={{fontSize:30}}>{live ?? "–"}</b>대</div>
            <div className="pc-tip-row" style={{fontSize:30}}><span className="pc-badge remain" style={{fontSize:30}}>남음</span><b style={{fontSize:30}}>{remain ?? "–"}</b>대</div>
        </div>
    );
}
        ...
        <div className="pc-wrap" role="region" aria-label={`${parkName} 주차장 상세`} >
            ...
            <div className="pc-header">
                ...
                <div className="pc-stats">
                    <h2 style={{fontSize:30}}>{lastWeekDateStr}</h2>
                </div>
                <div className="pc-stats">
                    <span className="pc-chip" style={{fontSize:30}}><span className="pc-dot live" style={{fontSize:30}} />피크 {maxPoint?.time} / {maxPoint?.liveCnt}대</span>
                    <span className="pc-chip" style={{fontSize:30}}><span className="pc-dot remain" style={{fontSize:30}}/>로우 {minPoint?.time} / {minPoint?.liveCnt}대</span>
                </div>
            </div>
