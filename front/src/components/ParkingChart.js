  ...
  return (
      <div className="pc-tooltip" role="dialog" aria-label="차트 툴팁">
        ...
        <div className="pc-tip-row">
          <span className="pc-badge live">주차</span>
          <b>{live ?? "–"}</b>대
        </div>
        <div className="pc-tip-row">
          <span className="pc-badge remain">여석</span>
          <b>{remain ?? "–"}</b>대
        </div>
      </div>
  );
      ...
      <div className="pc-wrap" role="region" aria-label={`${parkName} 주차장 상세`}>
        ...
        <div className="pc-header">
          <div className="pc-header-main">
            ...
            <div className="pc-date" style={{fontSize:20}}>{lastWeekDateStr}</div>
          </div>
          ...
          {maxPoint && minPoint && (
            ...
            <span className="pc-note" style={{fontSize:15}}>
